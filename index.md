...
<style>
  @import url('{{ "/_sass/custom.scss" | relative_url }}');
</style>

<div class="big-title">Theralogio: Current Project State</div>
...
<div class="subtitle">Need to have</div>
...
<div class="subtitle">Nice to have</div>
